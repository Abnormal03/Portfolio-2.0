...
const GetInTouch = () => {
    ...
    return (
        <div className='w-full bg-primary-dark/10 p-5 rounded-xl flex flex-col items-center gap-5 animate-swipe delay-150'>
            ...
            <div className='flex flex-col gap-5 lg:flex-row items-center lg:gap-10 '>
                <button className=' text-neutral-dark bg-linear-to-r from-secondary-dark to-primary-dark px-4 rounded-3xl py-2 hover:shadow-lg shadow-primary-dark hover:scale-105 transition-all duration-1000' onClick={() => navigate('/hireme')}>Get in Touch</button>
