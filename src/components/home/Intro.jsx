    ...
    return (
        <div className='text-white lg:gap-20 lg:grid grid-cols-2 mt-5 lg:px-5 lg:p-0 items-center px-3'>
            <div className='lg:mx-10'>
                ...
                <h1 className='font-bold text-5xl lg:text-7xl mb-5 animate-reveal delay-150'>Hi, I'm <span className='bg-clip-text text-transparent bg-linear-to-r from-primary-dark to-secondary-dark'>Abrham</span>,<br /> Full-Stack Developer.</h1>
                <p className='text-gray-500 mb-5 animate-reveal delay-150'>An Information Systems student and developer. I turn ideas into functional, production-ready code, focusing on utility-first styling and robust API architectures that scale with your users.</p>
                <div className='flex gap-3 animate-reveal delay-150'>
